...
check("R6 از Next.js 16.3.3 به‌عنوان Security baseline استفاده می‌کند", has("package.json", '"next": "16.3.3"') && has("INSTALL_ELORIA_R6.ps1", "Synchronizing free dependencies"));
