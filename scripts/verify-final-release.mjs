...
check("R8.3.3 موشن کلاسیک سریع اسلایدشو بازگردانی شده است", has("src/components/home-featured-album.tsx", "duration: reducedMotion ? 0 : 0.78") && has("src/components/home-featured-album.tsx", "scale: 0.965") && has("src/components/home-featured-album.tsx", "y: 22") && !has("src/components/home-featured-album.tsx", "mix-blend-screen") && !has("src/components/home-featured-album.tsx", "setDirection"));
