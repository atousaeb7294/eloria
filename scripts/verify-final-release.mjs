...
check("خانه اسلایدشوی حرفه‌ای خودکار، دستی و لمسی دارد", has("src/components/home-featured-album.tsx", "AUTOPLAY_MS") && has("src/components/home-featured-album.tsx", "handleTouchEnd") && has("src/components/home-featured-album.tsx", "AnimatePresence") && has("src/components/home-featured-album.tsx", "useReducedMotion"));
...
check("R8.3.2 اسلایدشو Silk Shader نرم و جهت‌دار است", has("src/components/home-featured-album.tsx", "mix-blend-screen") && has("src/components/home-featured-album.tsx", "mix-blend-soft-light") && has("src/components/home-featured-album.tsx", "setDirection") && has("src/components/home-featured-album.tsx", "AUTOPLAY_MS / 1000") && has("src/components/home-featured-album.tsx", "will-change-[transform,opacity,filter]"));
