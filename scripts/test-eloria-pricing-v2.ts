...
assert.equal(gold.taxToman, "0");
assert.equal(gold.finalPriceToman, "23570000");
...
assert.equal(composite.taxToman, "0");
assert.equal(composite.finalPriceToman, "23895000");
...
assert.equal(2n * BigInt(gold.finalPriceToman) + BigInt(calculateShipping(gold.finalPriceToman).shippingToman),47310000n);
