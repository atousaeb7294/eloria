...
const contracts = [
  ...
  ["Real security alert channel", Boolean(value("ELORIA_SECURITY_ALERT_WEBHOOK_URL")) || (/^09\d{9}$/.test(value("ELORIA_SECURITY_ALERT_MOBILE")) && value("KAVENEGAR_API_KEY").length >= 16)],
];
console.log("");
