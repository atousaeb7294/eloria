...
- فونت خودمیزبان ایران نستعلیق برای تمام متن فارسی دسکتاپ و Vazirmatn امن برای موبایل
- محدودسازی هزینه Intro
- خروج Cron از Process وب
- احراز هویت مشتری موبایل‌محور با SMS.ir، ورود رمزدار، عضویت، بازیابی رمز و تغییر رمز در پروفایل
