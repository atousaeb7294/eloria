-- Extend closed-market sales from 96 hours to 10 days.
-- The application applies material-specific age tiers; these values are the
-- operational ceiling and minimum configured margin.
ALTER TABLE "pricing_policies"
  ALTER COLUMN "closedMarketMaxAgeMinutes" SET DEFAULT 14400,
