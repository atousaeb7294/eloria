...
$backup = "C:\eloria_backup_final_$stamp"
$safe = "C:\eloria_safe_final_$stamp"
...
Write-Host "[2/7] Applying complete ELORIA release..." -ForegroundColor Cyan
...
Write-Host "[7/7] Upgrade completed successfully." -ForegroundColor Green
