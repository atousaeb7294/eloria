...
$backup = "C:\eloria_backup_r8_3_2_$stamp"
$safe = "C:\eloria_safe_r8_3_2_$stamp"
...
Write-Host "[2/7] Applying ELORIA R8.3.2..." -ForegroundColor Cyan
...
Write-Host "ELORIA R8.3.2 installed successfully." -ForegroundColor Green
