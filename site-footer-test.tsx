...
export function SiteFooter({ locale }: SiteFooterProps) {
  ...
  const copy = isPersian
    ? {
        shopTitle: "┘ü╪▒┘ê╪┤┌»╪º┘ç",
        brandTitle: "╪º┘ä┘ê╪▒█î╪º",
        categoryTitle: "╪»╪│╪¬┘çΓÇî╪¿┘å╪»█îΓÇî┘ç╪º",
        products: "╪¬┘à╪º┘à ╪ó╪½╪º╪▒",
        collections: "┘à╪┤╪º┘ç╪»┘ç ╪»╪│╪¬┘çΓÇî╪¿┘å╪»█îΓÇî┘ç╪º",
        cart: "╪│╪¿╪» ╪«╪▒█î╪»",
        about: "╪»╪º╪│╪¬╪º┘å ╪º┘ä┘ê╪▒█î╪º",
        journal: "┘à╪¼┘ä┘ç┘ö ╪º┘ä┘ê╪▒█î╪º",
        home: "╪«╪º┘å┘ç",
        contact: "╪¬┘à╪º╪│ ╪¿╪º ┘à╪º",
        necklaces: "┌»╪▒╪»┘å╪¿┘å╪»┘ç╪º",
        bracelets: "╪»╪│╪¬╪¿┘å╪»┘ç╪º",
        earrings: "┌»┘ê╪┤┘ê╪º╪▒┘çΓÇî┘ç╪º",
        rights: "╪¬┘à╪º┘à ╪¡┘é┘ê┘é ╪¿╪▒╪º█î ELORIA ┘à╪¡┘ü┘ê╪╕ ╪º╪│╪¬.",
        top: "╪¿╪º╪▓┌»╪┤╪¬ ╪¿┘ç ╪ó╪║╪º╪▓",
        signature: "╪¼┘ê╪º┘ç╪▒╪º╪¬█î ╪¿╪º ╪▒┘ê╪º█î╪¬ ╪º█î╪▒╪º┘å ┌⌐┘ç┘å",
      }
    : {
        shopTitle: "Shop",
        brandTitle: "Eloria",
