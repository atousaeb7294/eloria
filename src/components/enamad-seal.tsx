...
export function EnamadSeal() {
  ...
  return <a href="https://trustseal.enamad.ir/?id=7632947&Code=TKWqLb98pevDEO1yEhZaHGCVgpfLlxKr" target="_blank" rel="noopener noreferrer" referrerPolicy="origin" aria-label="استعلام اینماد الوریا" className="grid size-32 place-items-center rounded-xl border border-[#dfc16f]/20 bg-black/15 p-2 text-center text-xs leading-6 text-[#dfc16f]">
