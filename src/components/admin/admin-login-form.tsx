...
export function AdminLoginForm({
  ...
  return (
    <form action={formAction} className="mt-8 space-y-5">
      ...
      <TurnstileWidget locale={locale} action="admin-login" onTokenChange={setTurnstileToken} />
      {!turnstileToken ? <p className="text-center text-[11px] leading-6 text-[#bcae8d]/55">پس از تکمیل تأیید امنیتی، دکمه ورود فعال می‌شود.</p> : null}
