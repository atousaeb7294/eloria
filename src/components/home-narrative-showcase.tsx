        ...
        <header className="mx-auto mb-10 grid max-w-[1180px] gap-7 border-b border-[#ddc16e]/10 pb-8 sm:mb-12 sm:grid-cols-[.72fr_1.28fr] sm:items-end sm:pb-10 lg:mb-14">
          ...
          <div className={isPersian ? "sm:text-right" : "sm:text-left"}>
            ...
            <p className="mt-4 max-w-2xl text-xs leading-7 text-[#c8b995]/48 sm:text-[13px]">
              {isPersian
                ? "به‌جای ردیف‌های تکراری، آثار الوریا مثل صفحات یک لوک‌بوک لوکس کنار هم می‌نشینند؛ انتخاب امروز با دادهٔ واقعی بازدید، فروش، منتخب‌ها و تازگی اثر به‌روز می‌شود."
                : "Instead of repetitive product grids, Eloria is composed like a luxury lookbook. Today's edit refreshes from real views, sales, favourites and freshness signals."}
            </p>
          </div>
        </header>
