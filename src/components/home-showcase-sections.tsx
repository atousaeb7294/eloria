...
export function HomeShowcaseSections({ locale }: HomeShowcaseSectionsProps) {
    ...
    const copy: HomeCopy = isPersian
        ? {
            ...
            finalDescription: "ØªÙ…Ø§Ù… Ø¢Ø«Ø§Ø± Ø§Ù„ÙˆØ±ÛŒØ§ Ø±Ø§ Ø¨Ø¨ÛŒÙ†ÛŒØ¯ Ùˆ Ø§Ù†ØªØ®Ø§Ø¨ Ø®ÙˆØ¯ Ø±Ø§ Ø¨Ø±Ø§Ø³Ø§Ø³ Ø¯Ø³ØªÙ‡â€ŒØ¨Ù†Ø¯ÛŒØŒ Ø¬Ù†Ø³ØŒ Ù…ÙˆØ¬ÙˆØ¯ÛŒ Ùˆ Ø¨Ø§Ø²Ù‡ Ù‚ÛŒÙ…Øª Ø¯Ù‚ÛŒÙ‚â€ŒØªØ± Ú©Ù†ÛŒØ¯.",
            finalPrimary: "ØªÙ…Ø§Ø´Ø§ÛŒ ØªÙ…Ø§Ù… Ø¢Ø«Ø§Ø±",
            finalSecondary: "Ù…Ø±ÙˆØ± Ú¯Ù†Ø¬ÛŒÙ†Ù‡â€ŒÙ‡Ø§",
            principles: [
                {
                    title: "مشخصات روشن",
