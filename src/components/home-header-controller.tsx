...
function NavigationIcon({
  ...
  if (type === "collections") {
    return (
      ...
      >
        ...
        />
        <path
          d="M5.5 7.7L12 11L18.5 7.7M12 11V19.5"
          stroke="currentColor"
          strokeWidth="1.1"
          strokeLinejoin="round"
          opacity="0.72"
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M8 15.1L10.15 13.3M16 15.1L13.85 13.3"
        stroke="currentColor"
        strokeWidth="1"
        strokeLinecap="round"
        opacity="0.55"
...
export function HomeHeaderController({ locale }: HomeHeaderControllerProps) {
  ...
  const accountLocale: "fa" | "en" = locale === "en" ? "en" : "fa";
  ...
  const navigationItems: NavigationItem[] = isPersian
    ? [
        {
          label: "داستان الوریا",
          description: "افسانهٔ مادر، پیمان نخستین و هفت نگهبان",
          href: `/${locale}/story`,
          icon: "story",
        },
        {
          label: "آتلیهٔ الوریا",
          description: "شخصیت‌ها، نگهبانان و محیط افسانه‌های پنهان",
          href: `/${locale}/atelier`,
          icon: "story",
        },
        {
          label: "درباره ما",
          description: "معرفی رسمی برند و زیورهای دست‌ساز الوریا",
          href: `/${locale}/about`,
          icon: "story",
        },
        {
    ...
    : [
        {
          ...
          description: "The mother legend, First Covenant and Seven Guardians",
          href: `/${locale}/story`,
          icon: "story",
        },
        {
          label: "The Eloria Atelier",
          description: "Characters, Guardians and hidden-legend settings",
          href: `/${locale}/atelier`,
          icon: "story",
        },
        {
          label: "About Eloria",
          description: "The official introduction to our handmade jewelry",
          href: `/${locale}/about`,
          icon: "story",
        },
        {
  ...
  useEffect(() => {
    ...
    const scheduleHeaderUpdate = () => {
      ...
      animationFrameId = window.requestAnimationFrame(updateHeaderMode);
    };

    const initialFrameId = window.requestAnimationFrame(updateHeaderMode);
        ...
        {!fullHeaderVisible && (
          ...
          >
            <div className="relative mx-auto flex h-[62px] max-w-[1180px] items-center justify-between rounded-[18px] border border-[#d9ba67]/24 bg-[linear-gradient(135deg,rgba(2,29,20,0.84),rgba(1,17,12,0.72))] px-2 shadow-[0_18px_60px_rgba(0,0,0,0.34),inset_0_1px_0_rgba(255,255,255,0.05)] backdrop-blur-2xl sm:h-[68px] sm:px-2.5">
              ...
              <button
                type="button"
                aria-label={isPersian ? "باز کردن منو" : "Open navigation"}
              ...
              <Link
                href={`/${locale}`}
                aria-label={isPersian ? "صفحه اصلی الوریا" : "Eloria home"}
                onClick={closeMenu}
              ...
              {/* ورود/عضویت و سبد همیشه روی Hero، دسکتاپ و موبایل قابل دسترس‌اند. */}
              <div className="relative z-10 flex shrink-0 items-center gap-1.5 sm:gap-2">
                <CustomerAccountHeaderButton locale={accountLocale} />
                <CartHeaderButton locale={locale} variant="compact" />
              </div>
            </div>
          </motion.header>
        )}
          ...
          <>
            ...
            >
              <div className="relative overflow-hidden rounded-[24px] border border-[#dabe68]/32 bg-[linear-gradient(150deg,rgba(4,54,38,0.985),rgba(1,26,18,0.99)_56%,rgba(1,14,10,0.995))] p-3 shadow-[0_34px_110px_rgba(0,0,0,0.72),0_0_42px_rgba(216,177,74,0.1)] backdrop-blur-3xl">
                ...
                <div className="relative mb-3 flex items-center justify-between rounded-[17px] border border-[#e0c06d]/14 bg-white/[0.022] px-4 py-3.5">
                  <div>
                    <p className="text-[11px] font-medium text-[#f3dfaa]">
                      {isPersian ? "جهان الوریا" : "The World of Eloria"}
                    </p>

                    <p className="mt-1.5 text-[10px] leading-5 tracking-[0.02em] text-white/52">
                      {isPersian
                        ? "داستان، آتلیه، معرفی رسمی و راه‌های ارتباطی"
                        : "Story, atelier, official introduction and contact"}
                    </p>
                  </div>
                ...
                {/* گزینه‌های منو */}
                <nav
                  aria-label={isPersian ? "منوی اصلی" : "Main navigation"}
                    ...
                    >
                      ...
                      >
                        ...
                        <span className="grid size-11 shrink-0 place-items-center rounded-[13px] border border-[#d8b85f]/18 bg-[#0c6648]/18 text-[#d7bd78]/64 transition duration-300 group-hover:border-[#e0c16d]/40 group-hover:bg-[#b99038]/[0.06] group-hover:text-[#f1d78e]">
                          <NavigationIcon type={item.icon} className="size-5" />
                        </span>
