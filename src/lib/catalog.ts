    ...
    for (const token of tokens) {
      and.push({
        OR: [
          ...
          { collection: { nameFa: { contains: token, mode: "insensitive" } } },
          { collection: { nameEn: { contains: token, mode: "insensitive" } } },
          { collection: { descriptionFa: { contains: token, mode: "insensitive" } } },
          { collection: { descriptionEn: { contains: token, mode: "insensitive" } } },
          { images: { some: { altFa: { contains: token, mode: "insensitive" } } } },
          { images: { some: { altEn: { contains: token, mode: "insensitive" } } } },
          { variants: { some: { titleFa: { contains: token, mode: "insensitive" } } } },
          { variants: { some: { titleEn: { contains: token, mode: "insensitive" } } } },
