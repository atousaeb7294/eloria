...
export function productionEnvironmentChecks(): Check[] {
  ...
  return [
    ...
    { key: "ELORIA_ADMIN_PASSWORD_DUPLICATE", required: false, valid: !(value("ELORIA_ADMIN_PASSWORD_HASH") && value("ELORIA_ADMIN_PASSWORD")), message: "فقط یکی از PASSWORD_HASH یا PASSWORD تعریف شود؛ مقدار هش اولویت دارد" },
    ...
    { key: "DATABASE_SSL_MODE", required: true, valid: ["verify-full", "require"].includes(value("DATABASE_SSL_MODE")), message: "اعتبارسنجی کامل TLS دیتابیس" },
