  ...
  return (
    <div className="mx-auto max-w-[1540px] space-y-7">
      ...
      <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
        ...
        <article className="rounded-[1.7rem] border border-[#d7b95f]/17 bg-[#061c15]/86 p-5">
          <div className="flex items-center justify-between">
            <ScrollText className="size-5 text-[#e4c673]" />
            <span className="text-2xl font-semibold text-[#f0db9b]">
              {new Intl.NumberFormat("fa-IR").format(
                health.productsMissingLegend,
              )}
            </span>
          </div>
          <p className="mt-5 text-xs text-[#d8c9aa]/64">افسانهٔ پنهانِ ناقص</p>
          <p className="mt-2 text-[11px] leading-6 text-[#c5b694]/52">
            هر محصول باید یک افسانهٔ یکتا و پیوند روشن با یکی از هفت نگهبان
            داشته باشد.
          </p>
        </article>
        ...
        <article className="rounded-[1.7rem] border border-[#d7b95f]/17 bg-[#061c15]/86 p-5">
          <div className="flex items-center justify-between">
            ...
            <span className="text-2xl font-semibold text-[#f0db9b]">
              {new Intl.NumberFormat("fa-IR").format(
                health.productsMissingAtelierMedia,
              )}
            </span>
          </div>
          <p className="mt-5 text-xs text-[#d8c9aa]/64">تصویر آتلیهٔ ناقص</p>
          <p className="mt-2 text-[11px] leading-6 text-[#c5b694]/52">
            تصویر شخصیت و فضای افسانه از گالری محصول انتخاب و در همان صفحه نمایش
            داده می‌شوند.
          </p>
        </article>
      </section>
