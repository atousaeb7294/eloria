  ...
  privacy: {
    fa: {
      ...
      sections: [
        ...
        { title: "نگهداری و امنیت", paragraphs: ["دسترسی به اطلاعات باید محدود، ثبت‌شده و متناسب با مسئولیت افراد باشد.", "اطلاعات فقط تا زمانی نگهداری می‌شود که برای اجرای سفارش، پشتیبانی، الزامات حسابداری/قانونی یا مقابله با سوءاستفاده لازم باشد و دسترسی به آن محدود به نیاز عملیاتی است."] },
      ],
    },
    en: {
      eyebrow: "Privacy",
      ...
      sections: [
        ...
        { title: "Storage and security", paragraphs: ["Access to information should be limited, logged and appropriate to each role.", "Information is retained only for as long as needed to fulfil orders, provide support, meet accounting/legal obligations or prevent abuse, with access restricted to operational need."] },
      ],
    },
  },
  terms: {
    fa: {
      ...
      sections: [
        ...
        { title: "رفتار مجاز", paragraphs: ["استفاده خودکار، ایجاد سفارش‌های غیرواقعی یا تلاش برای اختلال در موجودی و سامانه ممنوع است.", "ثبت سفارش یا استفاده از خدمات به‌معنای پذیرش همین شرایط منتشرشده در زمان استفاده است؛ تغییرات بعدی از زمان انتشار جدید اعمال می‌شوند."] },
      ],
    },
    en: {
      eyebrow: "Terms",
      ...
      sections: [
        ...
        { title: "Permitted use", paragraphs: ["Automated misuse, fake orders or attempts to disrupt stock and services are prohibited.", "Placing an order or using the service means accepting the version of these terms published at that time; later changes apply from their new publication date."] },
      ],
    },
  },
  shipping: {
    fa: {
      ...
      sections: [
        ...
        { title: "تحویل", paragraphs: ["تحویل سفارش‌های ارزشمند می‌تواند نیازمند احراز هویت یا امضای گیرنده باشد.", "روش ارسال، هزینه قابل پرداخت و اطلاعات رهگیری مرتبط با هر سفارش در زمان تسویه یا پس از تحویل بسته به شرکت حمل در همان سفارش ثبت و قابل پیگیری است."] },
      ],
    },
    en: {
      eyebrow: "Shipping",
      ...
      sections: [
        ...
        { title: "Delivery", paragraphs: ["High-value deliveries may require identity verification or a recipient signature.", "The shipping method, payable cost and tracking information applicable to each order are recorded at checkout or once the parcel is handed to the carrier and remain traceable with that order."] },
      ],
    },
  },
  returns: {
    fa: {
      ...
      sections: [
        ...
        { title: "موارد قابل قبول", paragraphs: ["آسیب هنگام تحویل، مغایرت مشخصات یا ارسال محصول اشتباه باید با اولویت بررسی شود.", "درخواست بازگشت محصولات سفارشی، تغییرسایز داده‌شده یا دارای حک اختصاصی با توجه به ماهیت سفارش، وجود ایراد یا مغایرت و الزامات قانونی قابل اعمال بررسی می‌شود."] },
        { title: "بازپرداخت", paragraphs: ["بازپرداخت پس از تأیید درخواست و براساس روش پرداخت اولیه انجام می‌شود.", "پس از تأیید بازپرداخت، نتیجه و شناسه‌های مرتبط در سوابق سفارش ثبت می‌شود و بازگشت وجه از مسیر پرداخت مورد تأیید فروشگاه پیگیری می‌شود."] },
      ],
    },
    en: {
      eyebrow: "Returns",
      ...
      sections: [
        ...
        { title: "Eligible cases", paragraphs: ["Delivery damage, specification mismatch or an incorrect product should receive priority review.", "Return requests for custom, resized or engraved products are assessed according to the nature of the order, any defect or mismatch, and applicable legal requirements."] },
        { title: "Refunds", paragraphs: ["Refunds are issued after approval and through the original payment method.", "Once a refund is approved, its outcome and references are recorded with the order and the funds are returned through the store-approved payment path."] },
      ],
    },
  },
};
