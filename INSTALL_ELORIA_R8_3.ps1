...
$backup = "C:\eloria_backup_r8_3_$stamp"
$safe = "C:\eloria_safe_r8_3_$stamp"
...
Write-Host "[2/7] Applying ELORIA R8.3..." -ForegroundColor Cyan
...
Write-Host "ELORIA R8.3 installed successfully." -ForegroundColor Green
